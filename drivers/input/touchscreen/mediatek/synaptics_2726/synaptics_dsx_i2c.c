...
#if 0
//[SM20][zihweishen] Modify to mt_eint_unmask and eint_registration not used begin 2015/11/11
...
//[SM20][zihweishen] Modify to mt_eint_unmask and eint_registration not used end 2015/11/11
//#else
...
/*[I53_M][zihweishen] Modify device node of glovemode to distinguish finger and glove 20160419 begin*/
static DEVICE_ATTR( glovemode_is_finger, S_IWUSR|S_IRUSR|S_IRGRP|S_IROTH, synaptics_glovemode_is_finger_show, synaptics_rmi4_store_error );
/*[I53_M][zihweishen] 20160419 end*/
...
static void elan_touch_sysfs_deinit(void)
{
  ...
  /*[Lavender][bozhi_lin] synaptics touch detect glove or finger in glove mode 20150720 begin*/
  sysfs_remove_file( android_touch_kobj, &dev_attr_glovemode_is_finger.attr );
  /*[Lavender][bozhi_lin] 20150720 end*/
...
//[Lavender][bozhi_lin] disable touch LDO_VGP1 in suspend state 20150327 begin
	if (!hwPowerOn(TPD_POWER_SOURCE, VOL_2800, "TP")) {
		printk("[B]%s(%d): Synaptics TPD power on fail", __func__, __LINE__);
	}
//[Lavender][bozhi_lin] 20150327 end
#endif
//*[Lavender][bozhi_lin] 20150720 end
...
static int tpd_local_init(void)
{
 ...
 //[SM20][zihweishen] Modify  to replace mt_eint_mask and mt_eint_registration begin 2015/11/11
	...
	printk("[SYNAPTICS]: I2C Touchscreen Driver local init\n");
 //[SM20][zihweishen] Modify  to replace mt_eint_mask and mt_eint_registration end 2015/11/11
