...
#define FW_IMAGE_NAME_DP "PD060SC-04A_DS5V4.4.1.25_PR1804153_00010006.img"
#define FW_IMAGE_NAME_SP "PD060SC-04A_DS5V4.4.1.25_PR1898977_00020005_Unlocked.img"
#define FW_IMAGE_NAME_AP "PD060SC-04A_DS5V4.4.1.25_PR1898977_00040010_Unlocked.img"
#else
...
enum tp_hw_run {
	SYNAPTICS_NONE = 0,
	SYNAPTICS_DP = 1, //DP1 & DP2
	SYNAPTICS_SP = 2, //SP  & AP1
	SYNAPTICS_AP = 3, //AP2
};
#endif
/*[Lavender][bozhi_lin] 20150402 end*/
...
{
	int retval;
	enum flash_area flash_area = NONEE;
...
/*[SM20][zihweishen] 20151130 end*/
/*[SM20][zihweishen] enable firmware upgrade by check version 20151130 begin*/
	else if (!strncmp(fwu->product_id, "s2726", 5)) {
...
#if defined(TP_HARDWARE_CHECK)
#if 1
		if (tp_hw_run >= SYNAPTICS_AP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_AP, MAX_IMAGE_NAME_LEN);
		}
/*[SM20][zihweishen] enable firmware upgrade by check version 20151130 begin*/
/*[Lavender][bozhi_lin] enable firmware upgrade by check version 20150714 begin*/
