...
//<2014/08/05-Yuting Shih. [Jessicatseng] Integrate backlight IC LM3533.
#if defined( BACKLIGHT_IC_LM3533 )
#include <leds_lm3533.h>
#endif
//>2014/08/05-Yuting Shih.
// >>> 2016/02/04-dangyiwang, porting lm3533 from cosmos/lavender L to M
...
static int __init mt65xx_leds_probe(struct platform_device *pdev)
{
  ...
  // <<< 2016/02/04-dangyiwang, porting lm3533 from cosmos/lavender L to M
  //<2014/07/31-Yuting Shih. [Jessicatseng-ricehuang] Integrate backlight IC LM3533. 
    #if defined( BACKLIGHT_IC_LM3533 )
      rc = lm3533_create_file( i );
    #endif
...
static int __init mt65xx_leds_init(void)
{
	...
	LEDS_DRV_DEBUG("[LED]%s\n", __func__);
// <<< 2016/02/04-dangyiwang, porting lm3533 from cosmos/lavender L to M
//<2014/08/05-Yuting Shih. [Jessicatseng-ricehuang] Integrate backlight IC LM3533. 
#if defined( BACKLIGHT_IC_LM3533 )
#if defined( LED_LM3533_EX_INIT )
	ret = lm3533_i2c_init( debug_enable_led );
	if( ret < 0 )
		printk("[LED] lm3533_i2c_init dev: %d...\n", ret );
  #if defined( LED_TRACE_INFO )
	else
		printk("[LED] lm3533_i2c_init result %d...\n", ret );
  #endif
#endif
#endif
//<2014/08/05-Yuting Shih.
