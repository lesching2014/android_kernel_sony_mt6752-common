...
#define SPI_MODULE_CLOCK 134300
	...
	/* set the timing */
	spi_writel ( ms, SPI_PAD_SEL_REG, 0);        //20141007 Thunder modify for DTV timing++
...
static int mt_spi_setup(struct spi_device *spidev)
{
	...
	if (!chip_config) {
		...
		//20141007 Thunder modify for DTV timing++
		//chip_config->high_time = 10;
		//chip_config->low_time = 10;
		chip_config->high_time = 8;
		chip_config->low_time = 8;
		//20141007 Thunder modify for DTV timing++
