...
//[Arima_lavender][RaymondLin] LCM 2nd source Truly R63422 driver  begin
#if defined( R63422_FHD_DSI_CMD_TRULY )
    &r63422_fhd_dsi_cmd_truly_lcm_drv,
#endif
//[Arima_lavender][RaymondLin] LCM 2nd source Truly R63422 driver  end

//<2014/09/09-Yuting Shih. Add the new LCM panel.
#if defined( NT35532_FHD_DSI_VDO_INNOLUX )
    &nt35532_fhd_dsi_vdo_innolux_lcm_drv,
#endif

#if defined( NT35532_FHD_DSI_VDO_TRULY )
    &nt35532_fhd_dsi_vdo_truly_lcm_drv,
#endif
//>2014/09/09-Yuting Shih.

//<2014/10/17-stevenchen, Add Truly R61335 LCM driver
#if defined( R61335_FHD_DSI_VDO_TRULY )
    &r61335_fhd_dsi_vdo_truly_lcm_drv,
#endif
...
//[Arima-Lavender][Raymond] Porting Innolux otm1906a 6" LCM driver begin
#if defined( OTM1906A_FHD_DSI_VDO_6INCH_INNOLUX )
    &otm1906a_fhd_dsi_vdo_6inch_innolux_lcm_drv,
#endif
//[Arima-Lavender][Raymond] Porting Innolux otm1906a 6" LCM driver end
