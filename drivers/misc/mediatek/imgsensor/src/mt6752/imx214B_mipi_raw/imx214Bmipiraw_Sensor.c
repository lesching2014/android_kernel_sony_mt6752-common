...
#include "imx214Bmipiraw_Sensor.h"

#define PFX "IMX214B_camera_sensor"
...
#if 0
#define IMX214B_OTP_SIZE 1388
#define IMX214B_LSC_addr  512  //0x0200
u8 IMX214B_OTPData[IMX214B_OTP_SIZE];
extern  int iReadData_B(unsigned int  ui4_offset, unsigned int  ui4_length, unsigned char * pinputdata);
#endif
...
//<2015/01/07-stevenchen, Remove unused camera to fix I2C error
	.i2c_addr_table = {0x34, 0xff}, //0x34, 0x20
...
static imgsensor_struct imgsensor = {
	...
	.i2c_write_id = 0x34,//<2014/08/22-kylechang> SLASEL=NC or Low
};
			...
			*sensor_id = ((read_cmos_sensor(0x0016) << 8) | read_cmos_sensor(0x0017));
			if (*sensor_id == imgsensor_info.sensor_id) {				
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
								printk("get imx214B ID, i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
//				iReadData_B(IMX214B_LSC_addr,IMX214B_OTP_SIZE,IMX214B_OTPData);//[Lavender]Midify the eFlash driver 20150502 Person				
				return ERROR_NONE;
			}	
...
//kin0603
UINT32 IMX214B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
