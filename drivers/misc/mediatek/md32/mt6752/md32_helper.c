...
unsigned char *md32_data_image = NULL;
unsigned char *md32_program_image = NULL;
unsigned char *md32_send_buff = NULL;
unsigned char *md32_recv_buff = NULL;
...
void swap_ipi_handler(int id, void *data, unsigned int len)
{
	...
	if (info_type == INFO_GROUP) {
		...
		swap_buf = kmalloc((g_group_info.group_num) * 4, GFP_ATOMIC);
