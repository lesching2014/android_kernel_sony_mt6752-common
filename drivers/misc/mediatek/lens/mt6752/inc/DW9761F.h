...
#define DW9761FIOC_G_MOTORINFO _IOR(DW9761F_MAGIC, 0, stDW9761F_MotorInfo)

#define DW9761FIOC_T_MOVETO _IOW(DW9761F_MAGIC, 1, u32)

#define DW9761FIOC_T_SETINFPOS _IOW(DW9761F_MAGIC, 2, u32)

#define DW9761FIOC_T_SETMACROPOS _IOW(DW9761F_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9761FIOC_G_MOTORMETAINFO _IOR(DW9761F_MAGIC, 4, stDW9761F_MotorMETAInfo)
#endif
