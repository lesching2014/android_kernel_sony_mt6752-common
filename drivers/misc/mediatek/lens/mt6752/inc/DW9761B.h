...
#define DW9761BIOC_G_MOTORINFO _IOR(DW9761B_MAGIC, 0, stDW9761B_MotorInfo)

#define DW9761BIOC_T_MOVETO _IOW(DW9761B_MAGIC, 1, u32)

#define DW9761BIOC_T_SETINFPOS _IOW(DW9761B_MAGIC, 2, u32)

#define DW9761BIOC_T_SETMACROPOS _IOW(DW9761B_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9761BIOC_G_MOTORMETAINFO _IOR(DW9761B_MAGIC, 4, stDW9761B_MotorMETAInfo)
#endif
