...
INT32 g_old_temperature =0x12345678;
...
#if defined(LAVENDER)
kal_int32 g_fg_dbg_bat_temp_volt = 0;
#endif
...
INT32 sw_bat_temp_enable = 0;
INT32 sw_bat_temp_volt = 1621;
// -20 = 2603
//   0 = 2291
//  10 = 2052
//  20 = 1770
...
#endif
#else
#if defined(LAVENDER) || defined(COSMOS)
extern int PMIC_IMM_GetOneChannelValue(upmu_adc_chl_list_enum dwChannel, int deCount, int trimd);
kal_int32 g_fg_battery_id_volt = 0;
kal_uint8 battery_pack_id = BATTERY_PACK_ERROR;
void get_battery_pack_id(void)
{
    int bat_id_volt, i;
    pmic_ldo_vol_sel(MT6325_POWER_LDO_VRF18_1, VOL_1800);
    pmic_ldo_enable(MT6325_POWER_LDO_VRF18_1, KAL_TRUE);
    #if defined(COSMOS)
    mdelay(5);
    #else
    #endif
    bat_id_volt = 1;
    bat_id_volt = PMIC_IMM_GetOneChannelValue(BATTERY_ID_CHANNEL_NUM, bat_id_volt, 1);
    battery_log(BAT_LOG_CRTI, "bat_id_volt: %d\n", bat_id_volt);
    pmic_ldo_enable(MT6325_POWER_LDO_VRF18_1, KAL_FALSE);
    #if defined(COSMOS)
    if (bat_id_volt > BAT_ID_VOLT_LEVEL_1)
        battery_pack_id = BATTERY_PACK_SONY_1282_1203;
    else
        battery_pack_id = BATTERY_PACK_SONY_1294_6964;
    #else
    #endif
    battery_log(BAT_LOG_CRTI, "bat pack id: %d\n", battery_pack_id);
}
#endif
#endif
...
int __batt_meter_init_cust_data_from_cust_header(struct platform_device *dev)
{
	...
	/* cust_battery_meter_table.h */
// <<< 2016/04/12-youchihwang. Battery. Porting from L to M
#if defined(COSMOS)
        
            if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id) 
                {
                batt_meter_table_cust_data.battery_profile_t0_size = sizeof(battery_profile_t0_SONY_1282_1203) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t0,
                                &battery_profile_t0_SONY_1282_1203,
                                sizeof(battery_profile_t0_SONY_1282_1203));
        
                    batt_meter_table_cust_data.battery_profile_t1_size = sizeof(battery_profile_t1_SONY_1282_1203) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t1,
                                &battery_profile_t1_SONY_1282_1203,
                                sizeof(battery_profile_t1_SONY_1282_1203));
        
                    batt_meter_table_cust_data.battery_profile_t2_size = sizeof(battery_profile_t2_SONY_1282_1203) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t2,
                                &battery_profile_t2_SONY_1282_1203,
                                sizeof(battery_profile_t2_SONY_1282_1203));
        
                    batt_meter_table_cust_data.battery_profile_t3_size = sizeof(battery_profile_t3_SONY_1282_1203) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t3,
                                &battery_profile_t3_SONY_1282_1203,
                                sizeof(battery_profile_t3_SONY_1282_1203));
        
                    batt_meter_table_cust_data.r_profile_t0_size = sizeof(r_profile_t0_SONY_1282_1203) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t0,
                                &r_profile_t0_SONY_1282_1203,
                                sizeof(r_profile_t0_SONY_1282_1203));
        
                    batt_meter_table_cust_data.r_profile_t1_size = sizeof(r_profile_t1_SONY_1282_1203) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t1,
                                &r_profile_t1_SONY_1282_1203,
                                sizeof(r_profile_t1_SONY_1282_1203));
        
                    batt_meter_table_cust_data.r_profile_t2_size = sizeof(r_profile_t2_SONY_1282_1203) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t2,
                                &r_profile_t2_SONY_1282_1203,
                                sizeof(r_profile_t2_SONY_1282_1203));
                    batt_meter_table_cust_data.r_profile_t3_size = sizeof(r_profile_t3_SONY_1282_1203) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t3,
                                &r_profile_t3_SONY_1282_1203,
                                sizeof(r_profile_t3_SONY_1282_1203));
                }else{
                    batt_meter_table_cust_data.battery_profile_t0_size = sizeof(battery_profile_t0_SONY_1294_6964) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t0,
                                &battery_profile_t0_SONY_1294_6964,
                                sizeof(battery_profile_t0_SONY_1294_6964));
        
                    batt_meter_table_cust_data.battery_profile_t1_size = sizeof(battery_profile_t1_SONY_1294_6964) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t1,
                                &battery_profile_t1_SONY_1294_6964,
                                sizeof(battery_profile_t1_SONY_1294_6964));
        
                    batt_meter_table_cust_data.battery_profile_t2_size = sizeof(battery_profile_t2_SONY_1294_6964) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t2,
                                &battery_profile_t2_SONY_1294_6964,
                                sizeof(battery_profile_t2_SONY_1294_6964));
        
                    batt_meter_table_cust_data.battery_profile_t3_size = sizeof(battery_profile_t3_SONY_1294_6964) / sizeof(BATTERY_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.battery_profile_t3,
                                &battery_profile_t3_SONY_1294_6964,
                                sizeof(battery_profile_t3_SONY_1294_6964));
        
                    batt_meter_table_cust_data.r_profile_t0_size = sizeof(r_profile_t0_SONY_1294_6964) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t0,
                                &r_profile_t0_SONY_1294_6964,
                                sizeof(r_profile_t0_SONY_1294_6964));
        
                    batt_meter_table_cust_data.r_profile_t1_size = sizeof(r_profile_t1_SONY_1294_6964) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t1,
                                &r_profile_t1_SONY_1294_6964,
                                sizeof(r_profile_t1_SONY_1294_6964));
        
                    batt_meter_table_cust_data.r_profile_t2_size = sizeof(r_profile_t2_SONY_1294_6964) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t2,
                                &r_profile_t2_SONY_1294_6964,
                                sizeof(r_profile_t2_SONY_1294_6964));
                    batt_meter_table_cust_data.r_profile_t3_size = sizeof(r_profile_t3_SONY_1294_6964) / sizeof(R_PROFILE_STRUC);
        
                    memcpy(&batt_meter_table_cust_data.r_profile_t3,
                                &r_profile_t3_SONY_1294_6964,
                                sizeof(r_profile_t3_SONY_1294_6964));
                }
#else
...
// <<< 2016/04/12-youchihwang. Battery. Porting from L to M
            ...
            if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id) 
                {
                    batt_meter_cust_data.q_max_pos_50 = Q_MAX_POS_50_SONY_1282_1203;
                    batt_meter_cust_data.q_max_pos_25 = Q_MAX_POS_25_SONY_1282_1203;
                    batt_meter_cust_data.q_max_pos_0 = Q_MAX_POS_0_SONY_1282_1203;
                    batt_meter_cust_data.q_max_neg_10 = Q_MAX_NEG_10_SONY_1282_1203;
                    batt_meter_cust_data.q_max_pos_50_h_current = Q_MAX_POS_50_H_CURRENT_SONY_1282_1203;
                    batt_meter_cust_data.q_max_pos_25_h_current = Q_MAX_POS_25_H_CURRENT_SONY_1282_1203;
                    batt_meter_cust_data.q_max_pos_0_h_current = Q_MAX_POS_0_H_CURRENT_SONY_1282_1203;
                    batt_meter_cust_data.q_max_neg_10_h_current = Q_MAX_NEG_10_H_CURRENT_SONY_1282_1203;
                    batt_meter_cust_data.oam_d5 = OAM_D5; /* 1 : D5,   0: D2 */
                }else{
                    batt_meter_cust_data.q_max_pos_50 = Q_MAX_POS_50_SONY_1294_6964;
                    batt_meter_cust_data.q_max_pos_25 = Q_MAX_POS_25_SONY_1294_6964;
                    batt_meter_cust_data.q_max_pos_0 = Q_MAX_POS_0_SONY_1294_6964;
                    batt_meter_cust_data.q_max_neg_10 = Q_MAX_NEG_10_SONY_1294_6964;
                    batt_meter_cust_data.q_max_pos_50_h_current = Q_MAX_POS_50_H_CURRENT_SONY_1294_6964;
                    batt_meter_cust_data.q_max_pos_25_h_current = Q_MAX_POS_25_H_CURRENT_SONY_1294_6964;
                    batt_meter_cust_data.q_max_pos_0_h_current = Q_MAX_POS_0_H_CURRENT_SONY_1294_6964;
                    batt_meter_cust_data.q_max_neg_10_h_current = Q_MAX_NEG_10_H_CURRENT_SONY_1294_6964;
                    batt_meter_cust_data.oam_d5 = OAM_D5; /* 1 : D5,   0: D2 */
                }
#else
...
*/
        // <<< 2016/04/12-youchihwang. Battery. Porting from L to M
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t0[0].percentage : %d \n", batt_meter_table_cust_data.battery_profile_t0[0].percentage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t0[0].voltage    : %d \n", batt_meter_table_cust_data.battery_profile_t0[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t1[0].percentage : %d \n", batt_meter_table_cust_data.battery_profile_t1[0].percentage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t1[0].voltage    : %d \n", batt_meter_table_cust_data.battery_profile_t1[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t2[0].percentage : %d \n", batt_meter_table_cust_data.battery_profile_t2[0].percentage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t2[0].voltage    : %d \n", batt_meter_table_cust_data.battery_profile_t2[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t3[0].percentage : %d \n", batt_meter_table_cust_data.battery_profile_t3[0].percentage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.battery_profile_t3[0].voltage    : %d \n", batt_meter_table_cust_data.battery_profile_t3[0].voltage);


        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t0[0].resistance : %d \n", batt_meter_table_cust_data.r_profile_t0[0].resistance);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t0[0].voltage    : %d \n", batt_meter_table_cust_data.r_profile_t0[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t1[0].resistance : %d \n", batt_meter_table_cust_data.r_profile_t1[0].resistance);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t1[0].voltage    : %d \n", batt_meter_table_cust_data.r_profile_t1[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t2[0].resistance : %d \n", batt_meter_table_cust_data.r_profile_t2[0].resistance);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t2[0].voltage    : %d \n", batt_meter_table_cust_data.r_profile_t2[0].voltage);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t3[0].resistance : %d \n", batt_meter_table_cust_data.r_profile_t3[0].resistance);
        battery_log(BAT_LOG_CRTI, "check zcv table    batt_meter_table_cust_data.r_profile_t3[0].voltage    : %d \n", batt_meter_table_cust_data.r_profile_t3[0].voltage);
       // >>> 2016/04/12-youchihwang. Battery. Porting from L to M
...
//<2015/04/17-tedwu, Add support for 2nd source battery pack.
    ...
    if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id) {
        Batt_Temperature_Table = Batt_Temperature_Table_SONY_1282_1203;
    } else {
        Batt_Temperature_Table = Batt_Temperature_Table_SONY_1294_6964;
    }
    bm_print(BM_LOG_CRTI, "bat pack: %d, TemperatureR: %d\r\n", 
            battery_pack_id, Batt_Temperature_Table[0].TemperatureR);
#endif 
//>2015/04/17-tedwu

	if (Res >= Batt_Temperature_Table[0].TemperatureR) {
		//TBatt_Value = -20;
		//<2014/10/21-tedwu, Customize Battery/Charging parameters.
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id) {
            tmp_Q_max_1 = Q_MAX_NEG_10_SONY_1282_1203;
        } else {
            tmp_Q_max_1 = Q_MAX_NEG_10_SONY_1294_6964;
        }
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id) {
            tmp_Q_max_2 = Q_MAX_POS_0_SONY_1282_1203;
        } else {
            tmp_Q_max_2 = Q_MAX_POS_0_SONY_1294_6964;
        }
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_1 = Q_MAX_POS_0_SONY_1282_1203;
        else
            tmp_Q_max_1 = Q_MAX_POS_0_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_2 = Q_MAX_POS_25_SONY_1282_1203;
        else
            tmp_Q_max_2 = Q_MAX_POS_25_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_1 = Q_MAX_POS_25_SONY_1282_1203;
        else
            tmp_Q_max_1 = Q_MAX_POS_25_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_2 = Q_MAX_POS_50_SONY_1282_1203;
        else
            tmp_Q_max_2 = Q_MAX_POS_50_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_1 = Q_MAX_NEG_10_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_1 = Q_MAX_NEG_10_H_CURRENT_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_2 = Q_MAX_POS_0_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_2 = Q_MAX_POS_0_H_CURRENT_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_1 = Q_MAX_POS_0_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_1 = Q_MAX_POS_0_H_CURRENT_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_2 = Q_MAX_POS_25_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_2 = Q_MAX_POS_25_H_CURRENT_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_1 = Q_MAX_POS_25_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_1 = Q_MAX_POS_25_H_CURRENT_SONY_1294_6964;
#else
...
#if defined(COSMOS)
        if (BATTERY_PACK_SONY_1282_1203 == battery_pack_id)
            tmp_Q_max_2 = Q_MAX_POS_50_H_CURRENT_SONY_1282_1203;
        else
            tmp_Q_max_2 = Q_MAX_POS_50_H_CURRENT_SONY_1294_6964;
#else
...
/*[Lavender][bozhi_lin] check batery waringing message and set charging state to discharging when over charing time 20150430 begin*/
#if 1
		if (sw_bat_temp_enable) {
			bat_temperature_volt = sw_bat_temp_volt;
		}
		else {
...
/*[Lavender][bozhi_lin] apply battery temperature table to meet R4=24K  20150211 begin*/
#if defined(LAVENDER)
		g_fg_dbg_bat_temp_volt = bat_temperature_volt;
#endif
/*[Lavender][bozhi_lin] 20150211 end*/
...
void fgauge_algo_run_get_init_data(void)
{
    ...
    // <<< 2016/02/12-youchihwang, Porting charger from Cosmos/Lavender Android L to Android M
    //<2015/05/09-tedwu, for low quality and capacity of AC adpator or PC.
    #if defined(COSMOS)
    ...
    #if defined(COSMOS)
    {
        ...
        input_CC_value = CHARGE_CURRENT_500_00_MA;
        battery_charging_control(CHARGING_CMD_SET_INPUT_CURRENT, &input_CC_value);
        msleep(25);
        input_CC_value = CHARGE_CURRENT_100_00_MA;
        battery_charging_control(CHARGING_CMD_SET_INPUT_CURRENT, &input_CC_value);
        msleep(25);
...
kal_int32 get_dynamic_period(int first_use, int first_wakeup_time, int battery_capacity_level)
{
	...
	return g_spm_timer;
#else
// <<< 2016/04/26-youchihwang. Battery. Modify the source of fuel gauge sync time.
#if 1
...
kal_int32 battery_meter_initial(void)
{
	...
	mutex_lock(&FGADC_mutex);
        //<2015/09/09-stevenchen, Fix kernel build error for OSS
        //<2015/04/15-tedwu, add for BAT_ID.
#if defined(LAVENDER) || defined(COSMOS)
            get_battery_pack_id();
#endif
        //>2015/04/15-tedwu
        //>2015/09/09-stevenchen
...
/*[Lavender][bozhi_lin] fix create FG_g_fg_dbg_bat_temp_volt stack error 20150312 begin*/
/*[Lavender][bozhi_lin] apply battery temperature table to meet R4=24K  20150211 begin*/
#if defined(LAVENDER)
static ssize_t show_FG_g_fg_dbg_bat_temp_volt(struct device *dev, struct device_attribute *attr,
					 char *buf)
{
	bm_print(BM_LOG_CRTI, "[FG] g_fg_dbg_bat_temp_volt : %d\n", g_fg_dbg_bat_temp_volt);
	return sprintf(buf, "%d\n", g_fg_dbg_bat_temp_volt);
}

static ssize_t store_FG_g_fg_dbg_bat_temp_volt(struct device *dev, struct device_attribute *attr,
					  const char *buf, size_t size)
{
	return size;
}

static DEVICE_ATTR(FG_g_fg_dbg_bat_temp_volt, 0664, show_FG_g_fg_dbg_bat_temp_volt, store_FG_g_fg_dbg_bat_temp_volt);
#endif
/*[Lavender][bozhi_lin] 20150211 end*/
/*[Lavender][bozhi_lin] 20150312 end*/

/*[Lavender][bozhi_lin] check batery waringing message and set charging state to discharging when over charing time 20150430 begin*/
#if 1
static ssize_t show_FG_g_fg_dbg_sw_bat_temp_status(struct device *dev,struct device_attribute *attr,
					char *buf)
{	
	bm_print(BM_LOG_CRTI, "[FG] g_fg_dbg_bat_temp=%d (sw_bat_temp_enable=%d,sw_bat_temp_volt=%d)\n", g_fg_dbg_bat_temp, sw_bat_temp_enable, sw_bat_temp_volt);
	return sprintf(buf, "%d (sw_bat_temp_enable=%d,sw_bat_temp_volt=%d)\n", g_fg_dbg_bat_temp, sw_bat_temp_enable, sw_bat_temp_volt);
}
static ssize_t store_FG_g_fg_dbg_sw_bat_temp_status(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
	if (2 == sscanf(buf, "%d %d", &sw_bat_temp_enable, &sw_bat_temp_volt)) {
		bm_print(BM_LOG_CRTI, "[FG] sw_bat_temp_enable = %d, sw_bat_temp_volt = %d\n", sw_bat_temp_enable, sw_bat_temp_volt);
	} else {
		bm_print(BM_LOG_CRTI, "[FG] format error!\n");
	}
    return size;
}
static DEVICE_ATTR(FG_g_fg_dbg_sw_bat_temp_status, 0664, show_FG_g_fg_dbg_sw_bat_temp_status, store_FG_g_fg_dbg_sw_bat_temp_status);
#endif
/*[Lavender][bozhi_lin] 20150430 end*/
/* ------------------------------------------------------------------------------------------- */
...
#if defined(LAVENDER)
/* ------------------------------------------------------------------------------------------- */
static ssize_t show_FG_g_fg_dbg_battery_id_volt(struct device *dev,
						    struct device_attribute *attr, char *buf)
{
	int id_volt = 0;
	int ret = 0;

	id_volt = PMIC_IMM_GetOneChannelValue(AUX_ADCVIN0_GPS,1,0);
	g_fg_battery_id_volt = id_volt;
	bm_print(BM_LOG_CRTI, "[FG] show_FG_g_fg_dbg_battery_id_volt : id_volt = %d\n", id_volt);

	bm_print(BM_LOG_CRTI, "[FG] show_FG_g_fg_dbg_battery_id_volt : %d\n", g_fg_battery_id_volt);
	return sprintf(buf, "%d\n", g_fg_battery_id_volt);
}

static ssize_t store_FG_g_fg_dbg_battery_id_volt(struct device *dev,
						     struct device_attribute *attr, const char *buf,
						     size_t size)
{
	return size;
...
static DEVICE_ATTR(FG_g_fg_dbg_battery_id_volt, 0664, show_FG_g_fg_dbg_battery_id_volt,
		   store_FG_g_fg_dbg_battery_id_volt);
#endif
...
/*[Lavender][bozhi_lin] apply battery temperature table to meet R4=24K  20150211 begin*/
#if defined(LAVENDER)
	ret_device_file = device_create_file(&(dev->dev), &dev_attr_FG_g_fg_dbg_bat_temp_volt);
#endif
/*[Lavender][bozhi_lin] 20150211 end*/
/*[Lavender][bozhi_lin] check batery waringing message and set charging state to discharging when over charing time 20150430 begin*/
	ret_device_file = device_create_file(&(dev->dev), &dev_attr_FG_g_fg_dbg_sw_bat_temp_status);
/*[Lavender][bozhi_lin] 20150430 end*/
...
/*[Lavender][bozhi_lin] create a file node to read BAT_ID voltage 20150317 begin*/
#if defined(LAVENDER)
	ret_device_file = device_create_file(&(dev->dev), &dev_attr_FG_g_fg_dbg_battery_id_volt);
#endif
/*[Lavender][bozhi_lin] 20150317 end*/
